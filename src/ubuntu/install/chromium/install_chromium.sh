...
CHROME_ARGS+=" --disable-infobars --disable-session-crashed-bubble --disable-component-update --no-first-run --disable-user-media-security --disable-sync --ignore-certificate-errors --kiosk"
###############################################################################
###############################################################################
